...
public class HomeScreen implements Screen {
	...
	public void show() {
		...
		table.add();
		table.add();
		table.add(userInfo).fillX().uniformX().pad(10, 0, 100, 5).width(Gdx.graphics.getWidth()/5);
		table.add(logout).fillX().uniformX().pad(10, 5, 100, 10).width(Gdx.graphics.getWidth()/5);
		table.row();
